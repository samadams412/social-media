...
const thoughtController = {
  ...
  async updateThought(req, res) {
    // runValidators: when running update validators, this refers to the query object instead of the document. Because queries have a neat .get() function, you can get the updated value of the property you want.
